...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	var cmbProvince1 = $('#'+_cmbProvince);
	var cmbCity1 = $("#"+_cmbCity);
	var cmbArea1 = $("#"+_cmbArea);
	
	var InitCity = 1;
	var InitArea = 1;
	
	//alert("InitCity:"+InitCity);
	//alert("InitArea:"+InitArea);

	//根据province参数，province控件的当前值
	function cmbSelectprovince(cmb, str)
	{
	...
	//根据city参数，初始化city控件的当前值
	function cmbSelectCity(cmb, str)
	{
		for(var i=0; i<cmb.options.length; i++)
		{
			if(cmb.options[i].value == str)
	...
	//根据area参数，初始化area控件的当前值
	function cmbSelectArea(cmb, str)
	{
		//alert("cmbSelectArea");
		for(var i=0; i<cmb.options.length; i++)
		{
	...
	function changeCity()
	{
		...
		if(InitArea.valueOf()){
			cmbSelectArea(cmbArea, defaultArea);
		}else{
			cmbArea1[0].selectedIndex =0;
			cmbArea1.selectmenu(); 
			cmbArea1.selectmenu('refresh');		
		}
	}
	...
	function changeProvince()
	{
		...
		//设置城市的默认值，通过字符串匹配的方式
		if(InitCity.valueOf()){
			cmbSelectCity(cmbCity, defaultCity);
		}else{
			cmbCity1[0].selectedIndex =0;
			cmbCity1.selectmenu(); 
			cmbCity1.selectmenu('refresh');		
		}		
		//alert("defaultCity is " +defaultCity);
	...
	cmbSelectprovince(cmbProvince, defaultProvince);
	changeProvince();
...
var provinceList = [
{name:'辽宁', cityList:[	
{name:'营口市', areaList:['鲅鱼圈区','站前区','西市区','老边区','盖州市','大石桥市','市辖区']},	
{name:'大连市', areaList:['大窑湾','中山区','西岗区','沙河口区','甘井子区','旅顺口区','金州区','长海县','瓦房店市','普兰店市','庄河市','市辖区']},		  
