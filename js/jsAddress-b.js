...
var addressInit = function(_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea)
{
	...
	function cmbSelect(cmb, str)
	{
		...
		if(str ==""){
			alert("str is null,cmb:"+cmb +" length:"+"cmb.options.length");			
			cmb.selectedIndex = 2;
	...
	function changeProvince()
	{
		...
		alert("Province:"+item.name);		
		iT++;
		if (iT.valueOf()>3){
			iT=1;
		}
		alert("iT:"+iT);
		//cmbSelecttest[0].selectedIndex = iT.valueOf();
		//cmbSelecttest.selectmenu("refresh");
				
		myselect[0].selectedIndex =iT.valueOf();
		//myselect.selectmenu("refresh");
		myselect.selectmenu(); 
		myselect.selectmenu('refresh');	
		alert("iT over");
