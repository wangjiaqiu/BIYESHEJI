...
<%@page import="com.tpmgr.manage.utils.Constant" %>
   <head>
	...
	<script type="text/javascript" src="<c:url value="/pages/basicdata/boxtypelist.js" />"></script>
  </head>
<body>
	<div>
		<table id="grid1"></table>
	</div>
	<div id="boxtype" width=100% align="left">
		<form id="formCondition" action="" method="post" enctype="multipart/form-data">
			<table id="base_t" class="tbFormCss" align="center" width=100%>
				<br/>
				<tr>
					<td width="30%" style="font-weight: bold;" align="right">箱型名称：</td>
					<td width="70%" align="left">
						<input type="text" id="boxTypeName" name="boxTypeName" style="width:120px" class="easyui-validatebox" required="true" maxlength="10"/>
					</td>
				</tr>
			</table>
			<br/>
