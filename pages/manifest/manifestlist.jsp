...
<script type="text/javascript" src="<c:url value="/pages/manifest/manifestlist.js" />"></script>
<style>
	...
	<div id="manifest" width=100% align="left">
		<form id="formCondition" action="" method="post" enctype="multipart/form-data" >
					...
					<td width="35%" align="left">
						<table width=100% align="left">
					         <tr width=100% align="left">
					          ...
					          <input type="text" id="price" name="price" style="width:150px" class="easyui-numberbox" precision=2 min="1" max="99999999" >
					          </td >		
					          <td width=30%>

								<input id="priceUnit" class="easyui-combobox"
									name="priceUnit" style="width: 50px;"
									panelHeight="auto"
									data-options="valueField: 'value',textField: 'label',data: [{label: '元/吨',value: '元/吨'},{label: '元/箱',value: '元/箱'},{label: '元/车',value: '元/车'}]" />
			...
			<table id="base_t1" class="ordersInfoCss" width=100%>
				<tr>
					<td style="font-weight: bold;" align="left" colspan="6">发货地址</td>
				</tr>
				<tr>
					<td width="10%" style="font-weight: bold;" align="right">省：</td>
					<td width="23%" align="left"><select id="sendProvince"  style="width:80px"></select></td>
					<td width="10%" style="font-weight: bold;" align="right">市：</td>
					<td width="24%" align="left"><select id="sendCity" style="width:90px"></select></td>
					<td width="10%" style="font-weight: bold;" align="right">区：</td>
					<td width="23%" align="left"><select id="sendArea" style="width:120px"></select></td>
				</tr>
				<tr>
					<td width="10%"  style="font-weight: bold;" align="right">地址：</td>
					<td width="57%" align="left" colspan="3">
						<input type="text" id="sendDetailedAddress" name="sendDetailedAddress" style="width:310px" class="easyui-validatebox"  maxlength="30"/>
					</td>
			...
			<table id="base_t2" class="ordersInfoCss" width=100%>
				<tr>
					<td style="font-weight: bold;" align="left" colspan="6">收货地址</td>
				</tr>
				<tr>
					<td width="10%" style="font-weight: bold;" align="right">省：</td>
					<td width="23%" align="left"><select id="receiveProvince"  style="width:80px"></select></td>
					<td width="10%" style="font-weight: bold;" align="right">市：</td>
					<td width="24%" align="left"><select id="receiveCity" style="width:90px"></select></td>
					<td width="10%" style="font-weight: bold;" align="right">区：</td>
					<td width="23%" align="left"><select id="receiveArea" style="width:120px"></select></td>
				</tr>
				<tr>
					<td width="10%"  style="font-weight: bold;" align="right">地址：</td>
					<td width="57%" align="left" colspan="3">
						<input type="text" id="receiveDetailedAddress" name="receiveDetailedAddress" style="width:310px" class="easyui-validatebox" maxlength="30"/>
					</td>
					<td width="10%" style="font-weight: bold;" align="right">日期：</td>
					<td width="23%" align="left">
